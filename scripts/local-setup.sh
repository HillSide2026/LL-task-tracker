...
echo ""
echo "     NOTE: --build compiles all Java services from source inside Docker"
echo "     (multi-stage build). First run takes ~5-10 min to download Maven deps."
echo "     Subsequent builds reuse the BuildKit Maven cache and are much faster."
echo ""
echo "     docker compose \\"
...
echo "    http://localhost:8889         — Traefik dashboard"
